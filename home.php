...
<body>
    <nav class="navbar navbar-light bg-white">
        <div class="brand_logo_container">
			<img src="https://cdn4.iconfinder.com/data/icons/animals-45/755/Giraffe-512.png" width="50px" height="50px" class="brand_logo" alt="Logo">
		</div>
                    ...
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="ml-2">
                                    <div class="h5 m-0">@ShafiraAY</div>
                                    <div class="h7 text-muted">Shafira Aulia Yasmin</div>
                                </div>
                            </div>
                            <div>
                                <div class="dropdown">
                    ...
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="ml-2">
                                    <div class="h5 m-0">@Shafira Aulia Yasmin</div>
                                    <div class="h7 text-muted">Shafira Aulia Yasmin</div>
                                </div>
                            </div>
                            <div>
